...
ExampleLayer::ExampleLayer() : m_PerspectiveCameraController(16.0f / 9.0f,true), gridWorld()
{
...
void ExampleLayer::OnUpdate(Timestep ts)
{
	...
	glm::mat4 projectionMatrix = glm::perspective(glm::radians(fov), (float)1280 / (float)720, nearF, 100.0f);

	glUniformMatrix4fv(location, 1, GL_FALSE, glm::value_ptr(m_PerspectiveCameraController.GetCamera().GetViewProjectionMatrix()));
